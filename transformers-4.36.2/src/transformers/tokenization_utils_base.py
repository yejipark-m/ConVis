...
class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
    ...
    def batch_decode(
        ...
        **kwargs,
        ...
        sentences = [sentence_decode[0] for sentence_decode in sentences_decode]

        # Extract the second elements of each tuple
        tokens_lists = [sentence_decode[1] for sentence_decode in sentences_decode]
        return sentences, tokens_lists
